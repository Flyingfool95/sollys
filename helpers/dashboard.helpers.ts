...
export function getTimeUntilNextEvent(sunriseSignal: Signal, sunsetSignal: Signal) {
    return computed(() => {
...
export function getDaylightDuration(sunriseSignal: Signal, sunsetSignal: Signal) {
    return computed(() => {
        const sunriseStr = sunriseSignal.value;
        const sunsetStr = sunsetSignal.value;
